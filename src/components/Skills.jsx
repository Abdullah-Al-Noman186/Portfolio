...
import {
  FaHtml5, FaCss3Alt, FaJs, FaReact, FaNodeJs, FaGitAlt, FaGithub, FaStripe,
} from "react-icons/fa";
import {
  SiTailwindcss, SiNextdotjs, SiTypescript, SiExpress, SiMongodb,
  SiMongoose, SiOpenai, SiFirebase, SiJsonwebtokens, SiFramer,
} from "react-icons/si";
import { MdDevices, MdSpeed, MdBrush, MdPublic } from "react-icons/md";
...
const skillCategories = [
  {
    ...
    skills: [
      ...
      { name: "Responsive",     icon: MdDevices,            color: "#38BDF8" },
      { name: "UI/UX",          icon: MdBrush,              color: "#C084FC" },
      { name: "Performance",    icon: MdSpeed,              color: "#34D399" },
      { name: "Cross-Browser",  icon: MdPublic,             color: "#FBBF24" },
    ],
  },
  {
  ...
  },
  {
    ...
    skills: [
      ...
      { name: "BetterAuth", icon: HiOutlineShieldCheck, color: "#00D4FF" },
  ...
  return (
    ...
    >
      ...
      <div className="max-w-7xl mx-auto px-6 lg:px-8 relative z-10">
        ...
        >
          <p className="text-cyan-400 uppercase tracking-[0.4em] font-semibold text-sm">Skills</p>
          <h2 className="text-4xl md:text-5xl font-bold mt-4">Technical Expertise</h2>
              ...
              <div className="grid grid-cols-2 gap-8">
                {category.skills.map((skill, i) => {
                  ...
                  return (
                    ...
                    >
                      <div
                        className="relative w-16 h-16 rounded-xl bg-slate-900/80 border border-white/10 flex items-center justify-center transition-all duration-300"
                        style={{ boxShadow: `0 0 25px ${skill.color}33` }}
                      >
                        <Icon
                          size={34}
                      ...
                      <span className="mt-3 text-sm text-gray-300 group-hover:text-white transition text-center">
                        {skill.name}
                      </span>
                    </motion.div>
                  );
